...
export interface ApiAnnuncioLavoroAnnuncioLavoro
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::annuncio-lavoro.annuncio-lavoro'
    > &
      Schema.Attribute.Private;
...
export interface ApiAziendaAzienda extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    annuncio_lavoros: Schema.Attribute.Relation<
      'oneToMany',
      'api::annuncio-lavoro.annuncio-lavoro'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiCandidaturaCandidatura extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    annuncio_lavoro: Schema.Attribute.Relation<
      'manyToOne',
      'api::annuncio-lavoro.annuncio-lavoro'
    >;
    ...
    stato: Schema.Attribute.Enumeration<
      ['In revisione ', 'Accettata', 'Rifiutata']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
